    ...
    try {
      ...
      if (schemas.body) {
        ...
        if (!bodyValidation.success) {
          ...
          throw new AppError("Request body validation failed", 400, "VALIDATION_ERROR", {
            errors,
          })
        }
      ...
      if (schemas.query) {
        ...
        if (!queryValidation.success) {
          ...
          throw new AppError("Query parameters validation failed", 400, "VALIDATION_ERROR", {
            errors,
          })
        }
      ...
      if (schemas.params) {
        ...
        if (!paramsValidation.success) {
          ...
          throw new AppError("Path parameters validation failed", 400, "VALIDATION_ERROR", {
            errors,
          })
        }
